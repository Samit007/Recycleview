...
//        contactsViewHolder.tvEmailId.setText(contacts.getEmailId());
//        contactsViewHolder.tvAddress.setText(contacts.getAddress());
        ...
        contactsViewHolder.imgProfile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("email",contacts.getEmailId());
    ...
    public class ContactsViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView tvName, tvPhone, tvEmailId,tvAddress;
        ...
        public ContactsViewHolder(@NonNull View itemView) {
            ...
            tvEmailId = itemView.findViewById(R.id.tvEmail);
